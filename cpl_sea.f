...
c mpk BEGIN for added heating
      real DUMMI(NLON,NLAT,12), DUMMI1(NLON,NLAT) 
c mpk END
...
C mpk BEGIN for added heating
C     Interpolation of heating to daily values
C   
      DO K=1,8
       DO IT=1,12
        DO J=1,NLAT
          DO I=1,NLON
            DUMMI(I,J,IT) = HEAT(I,J,K,IT)       
          ENDDO
        ENDDO
       ENDDO 
       CALL FORIN5 (NGP,IMONT1,TMONTH,DUMMI,DUMMI1)
       DO J=1,NLAT
         DO I=1,NLON
           HEAT1(I,J,K) = DUMMI1(I,J)       
         ENDDO
       ENDDO      
      ENDDO 
